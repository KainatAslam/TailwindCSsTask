...
const BranchForm = () => {
  return (
    <>
      <form className="px-8 my-32 max-w-4xl mx-auto space-y-6">
        <div className="flex">
          <input
            type="text"
            name="productName"
        ...
        <div className="flex">
          ...
          <div className="flex">
            ...
            <select name="Quantity" class="mt-1 px-3 py-2  ml-8 bg-white border text-center w-[11.5rem] shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500   sm:text-sm "
              placeholder="Qty">
              <option >Qty</option>
              <option >...</option>
              <option>...</option>
            ...
            <select name="Unit" class="mt-1 px-3 py-2  bg-white border text-center w-[11.5rem] shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500  sm:text-sm "
              placeholder="Unit">
              <option>Units</option>
              <option>...</option>
              <option>...</option>
        ...
        <div className="flex">
            ...
            <select name="Category" class="mt-1 px-3 py-2 mr-12 bg-white border shadow-sm w-1/2 border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block  sm:text-sm "
